...
public class DpPreference extends Preference
    ...
    public DpPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        int PD = (percentToPixels(progress) + 25);
        monitorBox.setText(PD + " dp");
        if (changer != null)
